...
import { AiOutlineTeam,AiOutlineAppstore ,AiOutlineMessage,AiOutlinePicture,AiOutlineLogout,AiOutlineBars} from "react-icons/ai";
...
function AdminSidebar() {
    const menus=[
        ...
        {name:"Properties",link:'/',icon:AiOutlineMessage},
        {name:"Trips",link:'/',icon:AiOutlinePicture},
        {name:"Sign Out",link:'/',icon:AiOutlineLogout},
...
< AiOutlineBars size={26} className="cursor-pointer" onClick={()=>setOpen(!open)}/>
    </div>
...
}} className={`whilespace-pre duration-500 ${!open && 'opacity-0 translate-x-28 overflow-hidden'}`}>
    {menu?.name}
    </h2>
<h2 
